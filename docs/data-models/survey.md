...
| `dataEndpoint`          | string                                            | undefined      | URL of the data endpoint for survey event data. If undefined, events are sent to SurveyCompo. You can specify your own data endpoint for data collection. (Available to Premium Plan only) |
